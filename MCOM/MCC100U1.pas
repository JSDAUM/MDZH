...
procedure TMCC100F1.FormDestroy(Sender: TObject);
begin
   MCC100F1 := nil;
end;

procedure TMCC100F1.FormClose(Sender: TObject; var Action: TCloseAction);
begin
   action := cafree;
end;

procedure TMCC100F1.bbt_CancelClick(Sender: TObject);
begin
   ModalResult := mrCancel;
   close;
end;

procedure TMCC100F1.ugd_PatListClick(Sender: TObject);
begin
    L_KeySeqno := ugd_PatList.Row;
end;

procedure TMCC100F1.bbt_ConfirmClick(Sender: TObject);
begin
   ...
   begin
      ...
      MDC100U1.ResultDenPatno:= ugd_List.Cells[11,L_KeySeqno];
...
procedure TMCC100F1.ugd_PatListDblClick(Sender: TObject);
begin
   bbt_ConfirmClick(sender);
end;

procedure TMCC100F1.FormShow(Sender: TObject);
begin
   L_KeySeqno := 1;
...
procedure TMCC100F1.ugd_OutPatListDrawCell(Sender: TObject; ACol,
  ARow: Integer; Rect: TRect; State: TGridDrawState);
begin
   ReSizeGridCol((Sender as TUltragrid), 5);
end;

procedure TMCC100F1.ugd_OutPatListClick(Sender: TObject);
begin
    L_KeySeqno := ugd_OutPatList.Row;
end;

procedure TMCC100F1.ugd_OutPatListDblClick(Sender: TObject);
begin
   bbt_ConfirmClick(sender);
end;

procedure TMCC100F1.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TMCC100F1.ugd_ListClick(Sender: TObject);
begin
    L_KeySeqno := ugd_List.Row;
end;

procedure TMCC100F1.ugd_ListDblClick(Sender: TObject);
begin
   bbt_ConfirmClick(sender);
end;
