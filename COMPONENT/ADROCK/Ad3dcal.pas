...
{$R AD3DCAL.RES}  { Include the Button Bitmaps                      }

interface

uses
  SysUtils, WinTypes, WinProcs, Messages, Classes, Graphics, Controls,
  Buttons,  Forms, Dialogs, StdCtrls, extCtrls, menus,
  {$ifdef UNREGISTERED}
  ShellAPI,
  {$ENDIF}
  AdDate;
...
Const
  {$ifdef UNREGISTERED}
  VersionString = '1.28 (Unregistered Shareware Version)';
  {$ELSE}
  VersionString = '1.28 (Registered Version)';
  {$ENDIF}
  crPointCursor = 20;
  crClickCursor = 21;
  crNoGoCursor = 22;
...
type
  TAdrock3dCalendarSpeedButton = class(TSpeedButton)
                                 Published
                                 property Color;
                                 end;
...
procedure Register;
begin
    RegisterComponents('uniHISPACK', [TAdrock3dCalendar]);
end;
...
{  TabStop                    := FALSE;}
  ...
  fMonthButtonPercentage      := 0.65;                   { Percentage of space for month buttons }
