...
begin
  ...
  // Draw Border
  Frame3D(Canvas, barRect, FBorderColor, FBorderColor, 1);

  // Calculate the Rect
  InflateRect(barRect, -2, -2);
  solvedRect := Rect(barRect.left, barRect.top, barRect.left + Longint(Trunc((barRect.right - barRect.left) * (FProgress * 0.01))), barRect.bottom);
