...
begin
  ...
  try
    ...
    textBounds := Rect(ClientRect.Left + 10, ClientRect.Top,
      ClientRect.Left + 10 + memoryBitmap.Canvas.TextWidth(caption),
      ClientRect.Top + (memoryBitmap.canvas.TextHeight(caption)));
    ...
    case FBorder of
      brFull:
        memoryBitmap.Canvas.Polyline([Point(ClientRect.left + 5, ClientRect.top + (Canvas.textHeight(caption) div 2)),
          ...
          Point(ClientRect.right-1, ClientRect.top + (Canvas.textHeight(caption) div 2)),
          Point(ClientRect.left + 12 + memoryBitmap.Canvas.textWidth(caption), ClientRect.top + (memoryBitmap.Canvas.textHeight(caption) div 2))]);
      brOnlyTopLine:
        begin
          memoryBitmap.Canvas.Polyline([Point(ClientRect.left + 5, ClientRect.top + (Canvas.textHeight(caption) div 2)), Point(ClientRect.left, ClientRect.top + (Canvas.textHeight(caption) div 2))]);
          memoryBitmap.Canvas.Polyline([Point(ClientRect.right-1, ClientRect.top + (Canvas.textHeight(caption) div 2)), Point(ClientRect.left + 12 + memoryBitmap.Canvas.textWidth(caption), ClientRect.top + (memoryBitmap.Canvas.textHeight(caption) div 2))]);
        end;
    end;
    ...
    begin
      ...
      DrawText(memoryBitmap.Canvas.Handle, PChar(Caption), Length(Caption), textBounds, DT_TOP or DT_LEFT or DT_SINGLELINE);
      OffsetRect(textBounds, -1, -1);
