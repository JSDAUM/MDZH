...
type
  ...
  private
    ...
    procedure SetOrientation(const Value: TAnimOrientation);
  protected
  ...
  published
    ...
    property Orientation: TAnimOrientation read FOrientation write SetOrientation;
...
procedure TFlatAnimation.SetOrientation(const Value: TAnimOrientation);
begin
  FOrientation := Value;
  Invalidate;
end;
