...
type
    ...
    // 2003.02.17 박종엽 (아래의 선언으로 대체)
    //FIELDID  = Word;
    {FIELDID  = Integer;     // 2003.02.14
    FLDLEN   = Word;
    //FLDKEY   = word;
    FLDKEY   = Integer;     // 2003.02.14
    NTH      = integer;
    FLDOCC   = Integer;
    FLDPOS   = Integer;  // 20030227
    pFIELDID = ^FIELDID;
    pFLDLEN  = ^FLDLEN;
    pFLDOCC  = ^FLDOCC;
    pFLDPOS  = ^FLDPOS;  //20030227  }
    FIELDID  = integer;
    FLDLEN   = Word;
    FLDKEY   = integer;
    NTH      = integer;
...
Function fbgetf(a:Pointer; b:FLDKEY; c:Pointer; d:pFLDLEN; e:pFLDPOS):NTH; cdecl; far;  //20030227
...
Function fbgetf(a:Pointer; b:FLDKEY; c:Pointer; d:pFLDLEN; e:pFLDPOS):NTH; cdecl; external TmaxDLL; //20030227
