...
{                                                                         }
{ Copyright © 2001 by TMS software                                        }
...
begin
  ...
  begin
    ...
    tdDueDate:
    begin
      su := FormatDateTime(FDateFormat,TodoItems.Items[Index].DueDate);
      DrawTextEx(Canvas.Handle,PChar(su),Length(su),r,Align or DT_END_ELLIPSIS or DT_SINGLELINE,nil);
    end;
    tdCreationDate:
    begin
      su := FormatDateTime(FDateFormat,TodoItems.Items[Index].CreationDate);
      DrawTextEx(Canvas.handle,PChar(su),Length(su),r,Align or DT_END_ELLIPSIS or DT_SINGLELINE,nil);
    end;
    tdCompletionDate:
    begin
      su := FormatDateTime(FDateFormat,TodoItems.Items[Index].CompletionDate);
      DrawTextEx(Canvas.handle,PChar(su),Length(su),r,Align or DT_END_ELLIPSIS or DT_SINGLELINE,nil);
    end;
    tdTotalTime:
    begin
    ...
    begin
      ...
      tpLowest: FPriorityImageList.Draw(Canvas,r.Left,r.Top,4,True);
      tpLow: FPriorityImageList.Draw(Canvas,r.Left,r.Top,3,True);
      tpNormal: FPriorityImageList.Draw(Canvas,r.Left,r.Top,2,True);
      tpHigh: FPriorityImageList.Draw(Canvas,r.Left,r.Top,1,True);
      tpHighest: FPriorityImageList.Draw(Canvas,r.Left,r.Top,0,True);
      end;
    end;
...
begin
  S.Read(Count, 4);
  Items.Clear;
  for i := 1 to Count do Items.Add.LoadFromStream(S);  
end;
...
{$ENDIF}
  ...
  begin
    EditedItem.Notes.Assign(StringListEditor.Lines);
  end
