...
begin
  ...
  begin
    ...
    repeat
      ...
      HTMLDraw(canvas,s,pr,imagelist,0,0,false,false,false,false,false,1.0,URLCol,anchor,stripped,xsize,ysize);
      ...
      CDDS_ITEMPOSTPAINT :begin
			       ...
			       begin
			        su:=s;
                             ...
                             HTMLDraw(canvas,su,r,fImages,0,0,false,false,false,false,false,1.0,fURLColor,anchor,stripped,xsize,ysize);
...
begin
 ...
 HTMLDraw(canvas,s,r,fImages,x,y,true,false,false,true,true,1.0,clBlue,a,s,xsize,ysize);
