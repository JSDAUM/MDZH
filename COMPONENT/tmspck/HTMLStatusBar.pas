...
begin
  ...
  case Panel.Style of
  psHTML:begin
          HTMLDraw(canvas,panel.Text,rect,fImages,0,0,false,false,false,false,(fTimerCount>5),1.0,clBlue,anchor,stripped,xsize,ysize);
         end;
  psProgress:begin
     ...
     tgtrect.top:=r.top+(((r.bottom-r.top)-canvas.textheight(pros)) shr 1);
...
begin
 ...
 anchor:='';
 if HTMLDraw(canvas,panels.items[idx].Text,r,fImages,x,y,true,false,false,true,true,1.0,fURLColor,anchor,stripped,xsize,ysize) then
  result:=anchor;
end;
