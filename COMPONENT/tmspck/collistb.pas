...
type
 ...
 public
  ...
  property Items[Index: Integer]: TListBoxColumnItem read GetItem write SetItem;
 ...
 public
  ...
  property Items[Index: Integer]: TListBoxItem read GetItem write SetItem;
  constructor Create(aOwner:TColumnListBox);
  function GetOwner: tPersistent; override;
...
begin
 ...
 if (odSelected in State) then Canvas.rectangle(r.left,r.top,r.right,r.bottom);
...
begin
  ...
  if (Idx >= 0) and FShowItemHint then
  begin
