  ...
  begin
    ...
    begin
      ...
      begin
        ...
        FSizeLbl.Caption := FProgressLabel + ' ' + FileSizeFmt(FSize) + ' of ' + FileSizeFmt(TotSize);
        {$IFDEF TMSDEBUG}
...
begin
  ...
  begin
    ...
    begin
      FProgress.Position := Round(100 * FSize / lpdword);
      FSizelbl.Caption := FProgressLabel + ' ' + FileSizeFmt(FSize)+' of '+FileSizeFmt(lpdword);
    end
    else
      FSizelbl.Caption := FProgressLabel + ' ' + FileSizeFmt(FSize);
...
begin
  ...
  repeat
    ...
    FSizeLbl.Caption := FProgressLabel + ' ' + FileSizeFmt(FSize) + ' of ' + FileSizeFmt(Sourcesize);
    FRateLbl.Caption := FRateLabel + ' ' + FileSizeFmtSpeed(Round(FSize / ((GetTickCount - tck) + 1) * 1000));
