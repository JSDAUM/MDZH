...
procedure Register;
begin
   RegisterComponents('Additional', [TUltraGrid]);
end;
...
var
   ...
   OutStr         :  array[0..1000] of char;
   Title_count    :  integer;
   i              :  integer;
   Out_Text       :  string;
   LF_Position    :  array[0..100] of integer;
begin
    if FixedRows = 0 then exit;

    string_length    := length(ATitle);

    strpcopy(OutStr,ATitle);
