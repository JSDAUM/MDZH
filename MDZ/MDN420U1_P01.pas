...
begin
            ...
            begin
               ...
               begin
                  ...
                  dadmdate := encodedate(strtoint(copy(Trim(ugd_History.Cells[1,ugd_History.Row]),1,4)),
                                         ...
                                         strtoint(copy(Trim(ugd_History.Cells[1,ugd_History.Row]),9,2)) ); //입원일자
   ...
   if strFromForm = 'MDN430F2' then // 응급간호기록지 [8]
   begin
      qrlb_Title.Caption := '응급간호기록지';
      QRLabel3.caption := '응급간호기록지';
